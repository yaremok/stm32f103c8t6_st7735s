...
//static uint8_t Displ_SpiAvailable = 1;
...
#else
		madctl = ST7735_MADCTL_MX | ST7735_MADCTL_MY | ST7735_MADCTL_BGR; //ST7735_MADCTL_RGB;
...
#else
		madctl = ST7735_MADCTL_MY | ST7735_MADCTL_MV | ST7735_MADCTL_BGR; //ST7735_MADCTL_RGB;
...
#else
		madctl = ST7735_MADCTL_BGR; //ST7735_MADCTL_RGB;
		_height = ST7735_HEIGHT;
		_width = ST7735_WIDTH;
		_xstart = _colstart;
		_ystart = _rowstart;
...
#else
		madctl = ST7735_MADCTL_MX | ST7735_MADCTL_MV | ST7735_MADCTL_BGR; //ST7735_MADCTL_RGB;
		_width = ST7735_HEIGHT;
		_height = ST7735_WIDTH;
		_ystart = _colstart;
		_xstart = _rowstart;
